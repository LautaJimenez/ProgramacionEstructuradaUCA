...
// Las pilas tienen 2 funciones: pop y push. Unicamente se accede a una pila mediante alguna de las dos funciones mencionadas. 

// Las pilas se llenan de arriba, y se sacan de arriba. Es como una "escalera". El ultimo en entrar es el primero en salir.
